...
module "slack_bot_worker" {
  ...
  plain_text_bindings = [
    ...
    { name = "DEFAULT_MODEL", value = "google-vertex-anthropic/claude-sonnet-5@default" },
    { name = "CLASSIFICATION_MODEL", value = "google-vertex-anthropic/claude-sonnet-5@default" },
